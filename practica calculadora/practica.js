...
document.getElementById("sr").addEventListener("click",muestraResultado);
...
// El método split() divide un objeto de tipo String en un array(vector) de cadenas mediante la separacion de la cadena en subcadenas
